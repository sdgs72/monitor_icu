-- Referrence https://github.com/MIT-LCP/mimic-code/blob/main/mimic-iii/concepts/firstday/labs_first_day.sql
...
CREATE TABLE labs_first_day (    
    ...
    aniongap_min decimal(22,10) unsigned NULL,
    aniongap_max decimal(22,10) unsigned NULL,
    albumin_min decimal(22,10) unsigned NULL,
    albumin_max decimal(22,10) unsigned NULL,
    bands_min decimal(22,10) unsigned NULL,
    bands_max decimal(22,10) unsigned NULL,
    bicarbonate_min decimal(22,10) unsigned NULL,
    bicarbonate_max decimal(22,10) unsigned NULL,
    bilirubin_min decimal(22,10) unsigned NULL,
    bilirubin_max decimal(22,10) unsigned NULL,
    creatinine_min decimal(22,10) unsigned NULL,
    creatinine_max decimal(22,10) unsigned NULL,
    chloride_min decimal(22,10) unsigned NULL,
    chloride_max decimal(22,10) unsigned NULL,
    glucose_min decimal(22,10) unsigned NULL,
    glucose_max decimal(22,10) unsigned NULL,
    hematocrit_min decimal(22,10) unsigned NULL,
    hematocrit_max decimal(22,10) unsigned NULL,
    hemoglobin_min decimal(22,10) unsigned NULL,
    hemoglobin_max decimal(22,10) unsigned NULL,
    lactate_min decimal(22,10) unsigned NULL,
    lactate_max decimal(22,10) unsigned NULL,
    platelet_min decimal(22,10) unsigned NULL,
    platelet_max decimal(22,10) unsigned NULL,
    potassium_min decimal(22,10) unsigned NULL,
    potassium_max decimal(22,10) unsigned NULL,
    ptt_min decimal(22,10) unsigned NULL,
    ptt_max decimal(22,10) unsigned NULL,
    inr_min decimal(22,10) unsigned NULL,
    inr_max decimal(22,10) unsigned NULL,
    pt_min decimal(22,10) unsigned NULL,
    pt_max decimal(22,10) unsigned NULL,
    sodium_min decimal(22,10) unsigned NULL,
    sodium_max decimal(22,10) unsigned NULL,
    bun_min decimal(22,10) unsigned NULL,
    bun_max decimal(22,10) unsigned NULL,
    wbc_min decimal(22,10) unsigned NULL,
    wbc_max decimal(22,10) unsigned NULL
);

insert into labs_first_day (
SELECT
