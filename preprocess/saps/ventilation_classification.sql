-- Reference https://github.com/MIT-LCP/mimic-code/blob/main/mimic-iii/concepts/durations/ventilation_classification.sql

-- 2546550
CREATE TABLE ventilation_classification (
    icustay_id mediumint unsigned NOT NULL,
    charttime datetime NOT NULL,
    MechVent mediumint unsigned NULL,
    OxygenTherapy mediumint unsigned NULL,
    Extubated mediumint unsigned NULL,
    SelfExtubated mediumint unsigned NULL
);    


INSERT INTO ventilation_classification(
